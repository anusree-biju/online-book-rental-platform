        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <tbody>
                    <?php 
                    $us = mysqli_query($con, "SELECT * FROM book_tb where approval_status ='pending'");
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($u['author']); ?></td>
                            ...
                            <td>
                                <!-- Actions -->
                                <a href="accepted.php?id=<?php echo $u['bid']; ?>" class="btn btn-success btn-sm">Accept</a>
                                <a href="rejected.php?id=<?php echo $u['bid']; ?>" class="btn btn-primary btn-sm">rejected</a>
