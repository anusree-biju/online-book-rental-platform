            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">book rented List</h4>
                    </div>
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">rented List</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <!--=============================================== -->
                                <div class="table-responsive">
                                    <table id="demo-foo-addrow" class="table m-t-30 no-wrap table-hover contact-list" data-page-size="10">
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $b['rid']; ?></td>
                                                <td><?php echo $b['username']; ?></td>
                                                <td><?php echo $b['week']; ?></td>
                                                <td><?php echo $b['status']; ?></td>
                                                <td><?php echo $b['rental_date']; ?></td>
                                                <td><?php echo $b['return_date']; ?></td>
                                                <td><?php echo $b['paid']; ?></td>
                                                <td><?php echo $b['order_status']; ?></td>
                                            </tr>
