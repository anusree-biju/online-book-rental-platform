...
if (isset($_POST['delete'])) {
    ...
    mysqli_query($con, "DELETE FROM user_tb WHERE uid = '$delete_id'");
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-addrow" class="table m-t-30 no-wrap table-hover contact-list" data-page-size="10">
                                        ...
                                        <tbody>
                                           <?php
                                            $a = mysqli_query($con, "SELECT * FROM user_tb WHERE role != 'admin'");
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form method="POST" action="" style="display:inline;">
                                                        <input type="hidden" name="delete_id" value="<?php echo $b['uid']; ?>">
                                                        <button type="submit" name="delete" class="btn btn-danger btn-sm" onclick="return confirm('Delete this user?')">delete</button>
                                                    </form>
